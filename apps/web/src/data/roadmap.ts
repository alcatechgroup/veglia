...
export const FEATURES: Feature[] = [
  // ── T1 · MVP ───────────────────────────────────────────────────────────────
  {
    ...
    description: "Auth multi-tenant, onboarding de empresa, isolamento por company_id. Provisionamento SaaS via Command Center.",
    phase: "T1",
    status: "done",
  ...
  },
  {
    ...
    description: "4 módulos em vídeo (4K, gravados) + quiz + certificado. Dois percursos: Colaborador e Gestor de RH. Galeria → assistir → quiz.",
    phase: "T1",
    status: "done",
    doc: "Plataforma de Compliance em Saúde.docx",
  },
  {
    ...
    description: "Calendário SBIm 2026/27 + cobertura vacinal real da empresa. Colaborador auto-reporta vacinas e atrasadas.",
    phase: "T1",
    status: "done",
  ...
  },
  {
    code: "F06",
    name: "Dashboard RH",
    description: "Visão gerencial: % compliance, evolução por colaborador, controle vacinal, certificados, In-Company. Sem mockups.",
    phase: "T1",
    status: "done",
    doc: "Plataforma de Compliance em Saúde.docx",
  },
